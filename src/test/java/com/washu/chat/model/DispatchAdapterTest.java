...
//        simulate create user
        // Error test
        String payload = "{\"username\":\"Ian\", \"age\":20, \"location\":\"na\", \"school\":\"washu\", \"joinedGroup\":[]}";
        da.updateProfile(userSess1, payload);
        assertEquals("there is no user", 0, userNameMap.size());

        // Success test
        da.createConnection(userSess1);
        payload = "{\"username\":\"Ian\", \"age\":20, \"location\":\"na\", \"school\":\"washu\", \"joinedGroup\":[]}";
        da.updateProfile(userSess1, payload);
...
//        simulate create user
        da.createConnection(userSess1);
        String payload = "{\"username\":\"zhaokangpan\", \"age\":20, \"location\":\"na\", \"school\":\"washu\", \"joinedGroup\":[]}";
        da.updateProfile(userSess1, payload);

//        simulate create room
        payload = "{\"groupName\":\"hello\",\"owner\":\"zhaokangpan\",\"minAge\":10,\"maxAge\":30,\"locations\":[\"na\"],\"schools\":[\"washu\"]}";
...
//        simulate create users
        ...
        payload = "{\"username\":\"Ian\", \"age\":40, \"location\":\"na\", \"school\":\"washu\", \"joinedGroup\":[]}";
...
//        simulate create room
        ...
        payload = "{\"groupName\":\"Comp504\",\"owner\":\"Ian\",\"minAge\":10,\"maxAge\":30,\"locations\":[\"na\"],\"schools\":[\"washu\"]}";
        da.creatChatRoom(payload);
